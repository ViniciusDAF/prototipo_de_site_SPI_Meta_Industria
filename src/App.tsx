...
import MonitoramentoErgonomicoPage from './components/MonitoramentoErgonomico';
import VerificacaoEpiPage from './components/VerificacaoEpi';
  ...
  return (
    <div className="min-h-screen bg-slate-100 overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === 'ergonomico' && (
          <MonitoramentoErgonomicoPage operarios={operarios} setores={setores} />
        )}

        {activeTab === 'verificacao-epi' && (
          <VerificacaoEpiPage operarios={operarios} />
        )}
      </main>
    </div>
  );
